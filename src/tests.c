...
//The branch prediction for not taken. Will always not be taken. NT = Not taken.
...
int branch_prediction_test_Bimodal(void* raw_data) {
    int pc = 0;
    //offset needs to be negative, for BranchHistoryTable[bimodal_index] to increment
    int offset = -1; 
    int size = 8;
